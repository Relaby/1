...
class Config:
    FLASK_SESSION_KEY : str = "MhCKiRpEvgHDTE6DQThoRgQu"
    AuthorizationKey : str = "ExampleKey"
    SQLALCHEMY_DATABASE_URI : str = "postgresql://postgres:0620@localhost:5432/postgres"
    ...
    DISCORD_ADMIN_LOGS_WEBHOOK : str = "https://discord.com/api/webhooks/1337863498587177052/mLW-7f11YiNEDno1C87x8641egWkaiAtONlseaSpkLNpp82xa5RoSs-Z4KkxQHBT8cTz"
